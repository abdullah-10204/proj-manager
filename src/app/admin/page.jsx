...
const ChecklistPage = () => {
    ...
    const handleUpdateAnswer = async (id) => {
        try {
            const response = await axios.post('/api/routes/checklist?action=updateAnswer', {
                id: id,
                answer: answerInput
            });
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="bg-blue-50 px-4 py-2 rounded-lg">
                        <p className="text-sm font-medium text-blue-800">
                            Completed: {checklistItems.filter(item => item.answer).length} / {checklistItems.length}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-4">
                {filteredItems.length === 0 ? (
                    ...
                    filteredItems.map(item => (
                        <div key={item._id} className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:border-blue-200 transition-colors">
                            <div className="p-5">
                                    ...
                                    {editingId === item._id ? (
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex space-x-2">
                                                <button
                                                    onClick={() => handleUpdateAnswer(item._id)}
